Public Class characterSheetForm
    ...
    Private Sub skillHelpIconBox_Click(sender As Object, e As EventArgs) Handles skillHelpIconBox.Click
        If skillHelpFormCount = 0 Then
            Dim skillHelpForm As New skillHelpForm
            skillHelpFormCount += 1
            skillHelpForm.Show()
        End If
    End Sub

    Private Sub attributeAllocationHelpIconBox_Click(sender As Object, e As EventArgs) Handles attributeAllocationHelpIconBox.Click
        If attributeAllocationFormCount = 0 Then
            Dim attributeAllocationHelpForm As New AttributeAllocationHelpForm
            attributeAllocationFormCount += 1
            attributeAllocationHelpForm.Show()
        End If
    End Sub

    Private Sub statRollHelpIconBox_Click(sender As Object, e As EventArgs) Handles statRollHelpIconBox.Click
        If statRollHelpFormCount = 0 Then
            Dim statHelpForm As New StatHelpForm
            statRollHelpFormCount += 1
            statHelpForm.Show()
        End If
    End Sub

    Private Sub classHelpIconBox_Click(sender As Object, e As EventArgs) Handles classHelpIconBox.Click
        If ClassHelpFormCount = 0 Then
            Dim ClassHelpForm As New ClassHelpForm
            ClassHelpFormCount += 1
            ClassHelpForm.Show()
        End If
    End Sub

    Private Sub subraceHelpIconBox_Click(sender As Object, e As EventArgs) Handles subraceHelpIconBox.Click
        If subraceHelpFormCount = 0 Then
            Dim subraceHelpForm As New SubraceHelpForm
            subraceHelpFormCount += 1
            subraceHelpForm.Show()
        End If
    End Sub

    Private Sub raceHelpIconBox_Click(sender As Object, e As EventArgs) Handles raceHelpIconBox.Click
        If raceHelpFormCount = 0 Then
            Dim raceHelpForm As New RaceHelpForm
            raceHelpFormCount += 1
            raceHelpForm.Show()
        End If
    End Sub

    Private Sub nameHelpIconBox_Click(sender As Object, e As EventArgs) Handles nameHelpIconBox.Click
        If nameHelpFormCount = 0 Then
            Dim nameHelpForm As New NameHelpForm
            nameHelpFormCount += 1
            nameHelpForm.Show()
        End If
    End Sub
